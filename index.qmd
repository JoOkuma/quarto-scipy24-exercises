...
n_penguins = penguins.shape[0]
```

This dataset contains size measurements, clutch observations, and blood isotope ratios for 314 adult foraging Adélie, Chinstrap, and Gentoo penguins observed on islands in the Palmer Archipelago near Palmer Station, Antarctica.
...
@fig-penguins-plotnine the relationship between body mass and flipper length of penguins.
